...
router.post('/seed', authenticate, authorize(['admin']), async (req, res) => {
  try {
    ...
    const users = [
      ...
      { name: 'Albus Dumbledore', email: 'admin@hogwarts.edu', role: 'admin', phone: '123-456-7890', password: hashedPassword },
      { name: 'Ollivander', email: 'seller@diagonalley.com', role: 'seller', phone: '123-456-7891', password: hashedPassword },
      { name: 'Harry Potter', email: 'customer@hogwarts.edu', role: 'customer', phone: '123-456-7892', password: hashedPassword },
      { name: 'Garrick Ollivander', email: 'ollivanders@example.com', role: 'seller', password: hashedPassword },
      { name: 'Tom Riddle', email: 'borgin.burkes@example.com', role: 'seller', password: hashedPassword },
    ];
    ...
    logger.info('✅ Promotions created');
